...
$ docker run --network futurama postgres
```
...
```
$ docker network create futurama
$ docker run --network futurama -p 8787:8787 futurama rocker/rstudio
```
...
```{bash, eval=FALSE}
# start gogs
docker run -p --name=gogs -p 10022:22 -p 10080:3000 -v /var/gogs:/data gogs/gogs
